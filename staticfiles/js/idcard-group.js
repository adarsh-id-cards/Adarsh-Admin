...
document.querySelectorAll('.list-btn').forEach(btn => {
    btn.addEventListener('click', function(e) {
        ...
        // TODO: ID Card Actions page not yet implemented in Django
        // For now, show alert
        alert(`ID Card Actions page not yet implemented. Action: ${actionType}, Group: ${groupName}`);
        /*
        ...
        window.location.href = `/idcard-actions/?${params.toString()}`;
        */
    });
});
...
// Switch to Group Setting page - handled in template inline script
// Navigation now uses Django URLs: /group/{group_id}/settings/
